  from psycopg2 import pool
    ...
    def send_campaign_email(search_query, email_template, auto_send):
        conn = get_db_connection()
        if conn:
            try:
                cur = conn.cursor()
    ...
    def handle_send_campaign(json):
        ...
        auto_send = json['auto_send']
        threading.Thread(target=send_campaign_email, args=(search_query, email_template, auto_send)).start()
